CREATE OR REPLACE FUNCTION public.admin_hide_city(
    city_id uuid,
...
BEGIN
    ...
    VALUES (v_admin_id, 'hide_city', 'city', city_id::text, city_id, COALESCE(metadata, jsonb_build_object('city_id', city_id)));
END;
$function$;