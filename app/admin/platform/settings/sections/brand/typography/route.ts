// Deprecated: city_brand_settings.typography has been removed per docs/DATA-MODEL.md.
// Typography now lives on city_design_system.published_theme.typography
// (see app/api/admin/settings/brand/typography).
...
export async function GET(req: Request) {
  try {
    ...
    return NextResponse.json(data?.published_theme?.typography ?? {});
  } catch (error) {
