// Deprecated: city_brand_settings.accent_color/accent_color_secondary have been
// removed per docs/DATA-MODEL.md. Palette now lives on
// city_design_system.published_theme.colors (see app/api/admin/settings/brand/palette).
